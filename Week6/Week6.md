...
Above, you have inferred a phylogeny, but have not calculated any level of *certainty* in your tree. For this portion of your assessment, I will make a new multifasta file available with a larger number of sequences. You will need to align these sequences, infer a phylogeny, assess the amount of *certainty* you h ave in your phylogewny by performing bootstraps on the alignment and phylogeny (whatever number you think is reasonable), and plot the phylogeny **with the bootstrapped values appearing on it**. Otherwise you can plot the phylogeny in any way you see fit.[^1]
